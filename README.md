...
[http://github.com/robey/kestrel/tree/master](Kestrel)

[http://github.com/ezmobius/nanite/tree/master](Rabbit)
...
```sh
bundle exec script/sweatshop -d
bundle exec script/sweatshop -d stop
```
